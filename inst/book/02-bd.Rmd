...
En la figura \@ref(fig:total-por-region) se pueden apreciar el total de reclamos al año por región^[Para obtener el total anual, el número de reclamos totales se dividió por 10.5, que es el número de períodos totales que se tienen hasta la fecha (año 2010 a mediados del año 2020).]. En números absolutos, la Región Metropolitana es la que presenta la mayor cantidad de reclamos. Si se tiene en cuenta la población^[Utilizando datos del CENSO 2017, se genera una tasa por cada 1.000 habitantes, diviendo el número de reclamos de la región por la población: $\bar{N}_{región} / pob_{región} * 1000$], 
