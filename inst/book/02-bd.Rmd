...
En la figura \@ref(fig:total-reclamos-mercado) se puede apreciar como ha evolucionado el número de reclamos a través del tiempo. Se muestran los resultados con el número de reclamos (figura superior) y con el logaritmo en base 10 (figura inferior), para poder discrimnar de mejor manera las diferencias cuando se tienen bajo o alto número de reclamos. Se aprecia un alza para el mercado financiero para el año 2012 y una alza generalizada desde principios de 2012 en adelante.
...
### Reclamos por tamaño de empresa
