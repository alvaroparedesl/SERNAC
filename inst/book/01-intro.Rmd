...
* Desarrollar una herramienta que permita monitorear la base de datos del reclamo del SERNAC y encontrar las agrupaciones definidas por ellos (mercado, industria, proveedor, entre otras), que presenten mayores aumentos/disminuciones con respecto al registro histórico.

### Objetivos específicos {-}

* Estandarizar y homologar la base de datos.
* Generar funciones que permitan agregar nuevos datos a la base de datos.
...
<!-- desde <http://tecpar.cl/SERNAC/dbf_v03.RData> (peso aprox, 200MB) -->
Una vez comprobado que todo funcione adecuadamanete, descargar los datos de reclamos. Descargar también la librería con los códigos <http://tecpar.cl/SERNAC/SERNAC_0.11.0.zip> y el archivo comprimido con datos auxiliares <http://tecpar.cl/SERNAC/aux_data.zip>.
