...
Una vez comprobado que todo funcione adecuadamanete, descargar los datos desde <http://tecpar.cl/SERNAC/dbf_v03.RData> (peso aprox, 200MB). Descargar también la librería con los códigos <http://tecpar.cl/SERNAC/SERNAC_0.10.0.zip> y el archivo comprimido con datos auxiliares <http://tecpar.cl/SERNAC/aux_data.zip>.
...
install.packages("SERNAC_0.10.0.zip", repos = NULL, type = "win.binary")
...
<!-- 1. filtrar por id del reclamo, es único (porque las bases de datos son acumulativas, enero, enero y febero, etc) -->
...
# TODO: Agregar posición al gráfico de plotly inicial. 
